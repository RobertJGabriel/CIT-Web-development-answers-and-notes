...
/**
 * Venga boys Team: Robert Gabriel, Matthew Cooney, Sebastian Blesznowski, Dave Cahill
 * 
...
public class Email_Reminder {
	...
	public static void main(String[] args) {
		...
		final String[] options = { "Set Reminder.", "Delete Message.","List Report.", "Send Message" };
		int option;
		while (true) {
	 ...
	 * 
	 * @param currentTime
	 *            Gets current time of the machine for stamping
	 */
	...
	/**
	 * 
	 * @param list   lists all emails and if they were sent or not.
	 */

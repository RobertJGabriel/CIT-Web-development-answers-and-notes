...
public class WriteRead {
	...
	static ArrayList<Patient> recoveredPatientList;
	String fileName;
	Object object;
	...
	public WriteRead(){
		...
		recoveredPatientList = new ArrayList <Patient>();
	}
	
	public void writeFile(String fileName, ArrayList <Doctor> object, ArrayList <Patient> patientList){
		try {
	...
	//	ArrayList<Doctor> recoveredDoctorList;/* = new ArrayList <Doctor> ();*/
		try{
			   ...
			   //de-serialize the List
			      ...
			      recoveredPatientList = (ArrayList)input.readObject();
			      input.close();
			      //display its data
	...
	public static ArrayList getRecoveredPatientList (){
		return recoveredPatientList;
	}

// US DST 2010 is from Sunday March 14 to Sunday November 7.
function isDst(d)
{
  var dst = 60;	// DST on by default.

  // Up until March 13 switch off DST.
  if( (d.getMonth() < 4 ) && (d.getDate() < 14) ) { dst = 0; }
  
  // After November 6 switch off DST.
  if( (d.getMonth() > 9 ) && (d.getDate() > 6) ) { dst = 0; }
...
function init()
{
 ...
 panel.innerHTML += "<hr>Welcome to "+offset+ " visitors" ;

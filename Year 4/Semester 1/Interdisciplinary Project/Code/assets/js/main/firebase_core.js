/*! @license Firebase v1.1.1 - License: https://www.firebase.com/terms/terms-of-service.html */
(function () {
    var k, ba = this;
    ...
    function Ga(a, b, c, d) {
        ...
        if (p(b) && b.length > 10485760 / 3 && 10485760 < wa(b).length) throw Error(a + "contains a string greater than 10485760 utf8 bytes" + Ha(d) + " ('" + b.substring(0, 50) + "...')");
        if (ja(b))
            for (var e in b)
                if (A(b,
                        e)) {
    ...
    k = cb.prototype;
    k.ta = function (a, b) {
        return new cb(this.ab, this.ea.ta(a, b, this.ab).M(null, null, !1, null, null))
    };
    k.remove = function (a) {
        return new cb(this.ab, this.ea.remove(a, this.ab).M(null, null, !1, null, null))
    };
    k.get = function (a) {
    ...
    var Rb = Qb("Opera") || Qb("OPR"),
        ...
        Tb = Qb("Gecko") && -1 == Nb.toLowerCase().indexOf("webkit") && !(Qb("Trident") || Qb("MSIE")),
        Ub = -1 != Nb.toLowerCase().indexOf("webkit");
    (function () {
        var a = "",
            b;
    ...
    k.N = function (a) {
        var b = D(a);
        return null === b ? this : this.P(b).N(Ua(a))
    };
    k.ha = function (a) {
        return gb(this.o, a)
    };
    ...
    Gc.prototype.Ta = function (a, b, c) {
        Hc(this, a);
        this.Jb[a] = this.Jb[a] || [];
        this.Jb[a].push({
            ca: b,
    ...
    function Zc(a, b, c) {
        ...
        b.host !== b.ia && (this.Ca = this.Ca + "&ns=" + b.Sa);
    ...
    Zc.prototype.open = function (a, b) {
        ...
        this.Y.onmessage = function (a) {
            if (null !== c.Y)
                if (a = a.data, c.Ma += a.length, Rc(c.ga, "bytes_received", a.length), ad(c), null !== c.frames) bd(c, a);
                else {
                    a: {
    ...
    k.Va = function () {
        this.Qa || (this.e("WebSocket is closing itself"), this.ac(), this.ka && (this.ka(this.Db), this.ka = null))
    };
    k.close = function () {
        this.Qa || (this.e("WebSocket is being closed"), this.ac())
    };
    ...
    function ed(a, b, c) {
        for (a.xc[b] = c; a.xc[a.eb];) {
            ...
            if (a.eb === a.Vc) {
                a.Ua && (clearTimeout(a.Ua), a.Ua(), a.Ua = null);
                break
            }
            a.eb++
        }
        ...
        ic(function () {
            if (!c.Qa) {
                c.na = new kd(function (a, b, d, h, m) {
                    ld(c, arguments);
                    if (c.na)
                        if (c.Oa && (clearTimeout(c.Oa), c.Oa = null), c.Db = !0, "start" == a) c.id = b, c.Td = d;
    ...
    k.Va = function () {
        this.Qa || (this.e("Longpoll is closing itself"), this.ac(), this.U && (this.U(this.Db), this.U = null))
    };
    k.close = function () {
        this.Qa || (this.e("Longpoll is being closed."), this.ac())
    };
    k.send = function (a) {
        a = u(a);
        this.Na += a.length;
    ...
    function ud(a) {
        ...
        0 < b && (a.kc = setTimeout(function () {
            a.kc = null;
            a.Ra || (a.C && 102400 < a.C.Ma ? (a.e("Connection exceeded healthy timeout but has received " + a.C.Ma + " bytes.  Marking connection healthy."), a.Ra = !0, a.C.nc()) : a.C && 10240 < a.C.Na ? a.e("Connection exceeded healthy timeout but has sent " +
                a.C.Na + " bytes.  Leaving connection alive.") : (a.e("Closing unhealthy connection after timeout."), a.close()))
        }, Math.floor(b)))
    }
    ...
    function Fd(a) {
        0 >= a.Yd ? (a.e("Secondary connection is healthy."), a.Ra = !0, a.w.nc(), a.w.start(), a.e("sending client ack on secondary"), a.w.send({
            t: "c",
            d: {
                t: "a",
                d: {}
    ...
    function Dd(a) {
        a.Ra || (a.qd--, 0 >= a.qd && (a.e("Primary connection is healthy."), a.Ra = !0, a.C.nc()))
    }
    ...
    function xd(a, b, c) {
        ...
        0 === a.qd ? (a.e("Primary connection is healthy."), a.Ra = !0) : setTimeout(function () {
            Ed(a)
        }, Math.floor(5E3))
    }

    function Ed(a) {
        a.Ra || 1 !== a.oa || (a.e("sending ping on primary."), Gd(a, {
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function Kd(a, b, c, d, e) {
        ...
        Md(this, 0);
        Ic.ib().Ta("visible", this.Je, this); - 1 === a.host.indexOf("fblocal") && Jc.ib().Ta("online", this.He, this)
    }
    var Ld = 0,
        Nd = 0;
    k = Kd.prototype;
    ...
    k.I = function (a, b, c) {
        ...
        Rd(this);
        (b = 40 == a.length) || (a = Hd(a).Uc, b = "object" === typeof a && !0 === B(a, "admin"));
        b && (this.e("Admin auth credential detected.  Reducing max reconnect time."), this.oc = 3E4)
    };
    k.Bd = function (a) {
        delete this.bb;
        this.T && this.Ia("unauth", {}, function (b) {
            a(b.s, b.d)
        })
    };
    ...
    Be.isAvailable = function () {
        return !!window.XMLHttpRequest && "string" === typeof (new XMLHttpRequest).responseType && (!(navigator.userAgent.match(/MSIE/) || navigator.userAgent.match(/Trident/)) || Ae())
    };
        ...
        (g = window.open(a, "_blank", "location=no")) && ia(g.addEventListener) ? (g.addEventListener("loadstart", function (a) {
            ...
            if (b = a && a.url) a: {
                ...
                try {
                    ...
                    q.href = f;
                    b = q.host === hc(ne).host && "/blank/page.html" === q.pathname;
                    break a
                } catch (s) {}
                b = !1
            }
    ...
    function Ge(a, b) {
        this.pd = ["session", a.yc, a.Sa].join(":");
        this.Ic = b
    }
    ...
    k.sd = function (a, b) {
        ...
        this.Zb(d, e, function (a, d) {
            !a && d && d.uid && c.La && c.La.uid && c.La.uid === d.uid && Pe(c);
            P(b, a)
        })
    };
    k.Tc = function (a, b) {
    ...
    function Ue(a, b, c, d, e) {
        ...
        }, 0) : (b = new(b.shift())(d.Lc), d = Ba(d.ub), d.v = "js-1.1.1", d.transport = b.Ab(), d.suppress_status_codes = !0, a = ye() + "/" + a.D.Sa + c, b.open(a, d, function (a, b) {
            if (a) P(e, a);
            else if (b && b.error) {
        ...
        for (var m = [], n = [], q = [], s = [], t = 0; t < b.length; t++) {
            ...
            switch (b[t].type) {
                ...
                case "child_removed":
                    ...
                    break;
                case "child_changed":
                    !this.j.P(w).f() && pf(c, w, aa) && (this.j = this.j.K(w, aa), s.push(b[t]));
                    break;
                case "child_moved":
                    var K = !this.j.P(w).f(),
                        N = pf(c, w, aa);
    ...
    qf.prototype.ec = function (a, b, c, d, e) {
        ...
        if (h.contains(m)) a = h.get(m), Ze(a, b, c, d, e);
            ...
            (b = (b = bb(I(this.pa, f), function (a) {
                ...
                if (b) return !0
            }, !0)) || null === this.n && !U(this.g, f).f()) && bf(a)
        }
        a.Vb()
    };
    ...
    function Bf(a, b) {
        if (a.n) {
            var c = a.n,
                ...
                m = lf(b);
            Od(a.n, b, function (c) {
                "ok" !== c ? (c = sc(c), O("on() or once() for " + b.path().toString() + " failed: " + c.toString()), Cf(a, b, c)) : g || (m ? yf(a, b.path(), !0) : Fb(h, function (a) {
                    (a = b.get(a)) && bf(a)
                }), Af(a, b.path()))
            });
            return function () {
    ...
    k.uc = function (a, b, c) {
        ...
        var d, e, f = [];
        9 <= a.length && a.lastIndexOf(".priority") === a.length - 9 ? (d = new H(a.substring(0, a.length - 9)), e = U(this.g.wa, d).Ka(b), f.push(d)) : c ? (d = new H(a), e = U(this.g.wa, d), pc(b, function (a, b) {
            var c = new H(b);
            ".priority" === b ? e = e.Ka(a) : (e = e.Ba(c, S(a)), f.push(d.J(b)))
    ...
    function Sf(a, b, c, d, e) {
        ...
        a.Ja.ba = Tf(a, a.Ja.ba, a.g.O.ba, a.$a);
        d = c.update(U(a.Ja, b).X());
        if (l(d)) {
    ...
    function Yf(a, b, c) {
        ...
        for (var f = U(a.Ja, b).X(!0), g = Yb(), h = Zf(c), d = 0; d < h.length; d++) Za(I(a.g.Sb, h[d]), g);
    ...
    Y.prototype.Pa = function () {
        for (var a in this.sb) this.sb[a].Pa()
    };
    ...
    Kd.prototype.sendRequest = Kd.prototype.Ia;
    Kd.prototype.interrupt = Kd.prototype.Pa;
    Z.fe = td;
    ...
    function G(a, b) {
        ...
        if (a instanceof Gf) c = a, d = b;
            ...
            e = d.toString();
            var f;
            !(f = !p(c.host) || 0 === c.host.length || !Ea(c.Sa)) && (f = 0 !== e.length) && (e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), f = !(p(e) && 0 !== e.length && !Da.test(e)));
